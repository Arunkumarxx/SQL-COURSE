...
-- when deleting records in a table! Notice the WHERE clause in
...
delete from  personal_database.customers
where personal_database.customers.CustomerName='Alfreds Futterkiste'
...
+------------+--------------------------------------+----------------------+------------------------------------------------+-----------------+------------+-------------+
 */
 # if u want to delete every thing from that table use following mehtod

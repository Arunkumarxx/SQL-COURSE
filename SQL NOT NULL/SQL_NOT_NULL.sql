...
# which means that you cannot insert a new record, or update a
...
where id =11;
alter table custom
    add column aruns varchar(255)not null;
...
|        122 | RandomCustomerName                   | RandomContactName    | 123 Random St                                  | RandomCity      | 123456    | RandomCountry |
|       1222 | RandomCustomerName                   | RandomContactName    | 123 Random St                                  | RandomCity      | 123456    | RandomCountry |
+------------+--------------------------------------+----------------------+------------------------------------------------+-----------------+-----------+---------------
 */